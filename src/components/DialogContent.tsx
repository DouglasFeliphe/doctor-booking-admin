  ...
  return (
    <Dialog.Portal>
      ...
      <Dialog.Popup
        ...
        className={twMerge(
          'fixed left-[50%] top-[50%] z-50 flex w-full max-w-[640px] translate-x-[-50%] translate-y-[-50%] flex-col gap-6 border border-border bg-surface p-8 shadow-lg duration-200 rounded-3xl outline-none',
